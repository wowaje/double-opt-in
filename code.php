				...
				<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
					...
					<div class="panel panel-success">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<div class="text-center"><h2><b>Paste Your Copied Reset Code Within The Below Box</b></h2></div>
									<form id="register-form"  method="post" role="form" autocomplete="off">
										<div class="form-group">
											<input type="text" name="code" id="code" tabindex="1" class="form-control" placeholder="paste here" value="" autocomplete="off" required/>
										</div>
										<div class="form-group">
											<div class="row">
